...
use crate::encode::{serialize, VarInt};
use crate::BlockHash;

pub use elements26::BlockExtData as ExtData;
pub use elements26::BlockHeader;
...
mod tests {
    ...
    fn test_failed_block() {
        ...
        let _block = crate::encode::deserialize::<Block>(&bytes).unwrap();
    }
}
