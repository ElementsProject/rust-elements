    ...
    ($ty:ty) => {
        impl FromHex for $ty {
            ...
            where
                I: Iterator<Item = Result<u8, Error>> + ExactSizeIterator + DoubleEndedIterator,
            {
                use bitcoin30::hashes::hex::Error as Error29;
                ...
                bitcoin30::hashes::hex::FromHex::from_byte_iter(iter).map_err(|err| match err {
...
impl_from_bitcoin29_hex!(bitcoin30::BlockHash);
impl_from_bitcoin29_hex!(bitcoin30::ScriptBuf);
impl_from_bitcoin29_hex!(bitcoin30::Txid);
*/
