...
//!
//! Adaptation of rust-bitcoin's implementation of BIP174 Partially Signed
//! Bitcoin Transaction Format as defined at
//! https://github.com/bitcoin/bips/blob/master/bip-0174.mediawiki
//! except we define PSBTs containing non-standard SigHash types as invalid.

use bitcoin::blockdata::script::Script;
use transaction::{Transaction, TxInWitness};
...
impl PartiallySignedTransaction {
    ...
    pub fn extract_tx(self) -> Transaction {
        ...
        for (vin, psbtin) in tx.input.iter_mut().zip(self.inputs.into_iter()) {
            ...
            vin.witness = TxInWitness {
                script_witness: psbtin.final_script_witness.unwrap_or_else(Vec::new),
                //TODO(stevenroose) fill
                amount_rangeproof: Vec::new(),
                inflation_keys_rangeproof: Vec::new(),
